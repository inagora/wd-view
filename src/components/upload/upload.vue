		...
		<div class="wd-upload-list-text-container" style="">
			...
			>
				<div class="wd-upload-list-item-info">
					<span class="wd-upload-span"><div class="wd-upload-text-icon">
							<span
								role="img"
						...
						<a class="wd-upload-list-item-name" :title="item.name">{{
							item && item.name
						}}</a><span class="wd-upload-list-item-card-actions"><!----><button
							...
							>
								<span
									...
									>
										...
										></path></svg></span></button></span></span>
				</div>
				<!---->
			</div>
		</div>
	...
	setup(props, { emit }) {
		...
		const changeHandler = (e) => {
			...
			if (!props.beforeUpload) {
				...
				const result = props.beforeUpload();
				if (result === false) {
					emitChange();
					return;
