<template>
	...
	<div class="wd-upload-list wd-upload-list-text">
		<div class="wd-upload-list-text-container" style="">
			<div
				v-for="(item, index) in successFiles"
				:key="index"
				class="wd-upload-list-item wd-upload-list-item-done wd-upload-list-item-list-type-text"
			>
				<div class="wd-upload-list-item-info">
					<span class="wd-upload-span"
						...
						<a class="wd-upload-list-item-name" title="打印.png">打印.png</a
			...
			<div
				...
				:key="index"
				class="wd-upload-list-item wd-upload-list-item-error wd-upload-list-item-list-type-text"
			>
				<div class="wd-upload-list-item-info">
					<span class="wd-upload-span"
						><div class="wd-upload-text-icon">
...
export default defineComponent({
	...
	setup(props, { emit }) {
		...
		const fileList = ref([]);
		const successFiles = ref([]); // 上传成功文件列表
		const errorFiles = ref([]); // 上传失败文件列表
		let currentFiles = [];
		// 请求参数
		// 上传回调
		...
		const delFileItem = (index, type) => {
			if (type === 'error') {
				errorFiles.value.splice(index, 1);
			} else {
				successFiles.value.splice(index, 1);
			}
		};
		return {
			uploadInput,
