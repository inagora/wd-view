...
export default {
	...
	render() {
		const iconMap = {
			close: (
				<span
					role="img"
					aria-label="close"
					class="anticon anticon-close wd-image-preview-operations-icon"
				>
					<svg
						focusable="false"
						class=""
			...
			'zoom-in': (
				<span
					role="img"
					aria-label="zoom-in"
					class="anticon anticon-zoom-in wd-image-preview-operations-icon"
				>
					<svg
						focusable="false"
						class=""
			...
			'zoom-out': (
				<span
					role="img"
					aria-label="zoom-out"
					class="anticon anticon-zoom-out wd-image-preview-operations-icon"
				>
					<svg
						focusable="false"
						class=""
			...
			'rotate-right': (
				<span
					...
					class="anticon anticon-rotate-right wd-image-preview-operations-icon"
				>
					<svg
						focusable="false"
						class=""
			...
			'rotate-left': (
				<span
					...
					class="anticon anticon-rotate-left wd-image-preview-operations-icon"
				>
					<svg
						focusable="false"
						class=""
		...
		return <div>{iconMap[this.icon]}</div>;
	},
};
</script>
