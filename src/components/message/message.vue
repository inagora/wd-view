<template>
  <div class="wd-message" :style="customStyle">
    <div>
      <div ref="messageNotice" class="">
...
export default {
  ...
  setup(props, ctx) {
    ...
    onMounted(() => {
      ...
      setTimeout(() => {
        messageNotice.value.classList.add('move-up-leave');
        messageNotice.value.classList.add('move-up-leave-active');
        ctx.emit('destroy');
      }, duration.value);
    });
    return {
